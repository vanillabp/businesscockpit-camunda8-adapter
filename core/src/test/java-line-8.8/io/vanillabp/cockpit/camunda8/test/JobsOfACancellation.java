...
/**
 * How a test says that a job reports the cancellation of its process instance. This is the 8.8
 * variant.
 * <p>
...
final class JobsOfACancellation {
  ...
  static void reportsACancellation(
    ...
    throw new IllegalStateException(
        "Camunda 8.8 hands out no job for a cancelled instance, so no test may build one!");
